...
public class ColorChange : MonoBehaviour
{
    ...
    [SerializeField] private int alfa;
    ...
    {
        if(mesh1.material.color.a > alfa && mesh2.material.color.a > alfa)
        {
            yield return null;
        }

        mesh1.material.color = mesh1.material.color + new Color32(0, 0, 0, 1);
        mesh2.material.color = mesh1.material.color + new Color32(0, 0, 0, 1);
    ...
    {
        if (mesh1.material.color.a == 0 && mesh2.material.color.a == 0)
        {
        ...
        mesh2.material.color = mesh1.material.color - new Color32(0, 0, 0, 2);
        yield return new WaitForSeconds(0.01f);
