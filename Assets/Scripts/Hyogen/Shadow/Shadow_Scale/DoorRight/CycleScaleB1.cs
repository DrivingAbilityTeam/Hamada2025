...
public class CycleScaleB1 : MonoBehaviour
{
    ...
    private float DisZ;
    private float rad;
    private float zvalue = 0.742f;//�e�̏����ʒu
    private float dx = 0.08f;//�X�P�[���ω��p
    private float dy = 0.08f;
    private float dz = 0.08f;
    private bool human;
    ...
    void Start()
    {
        ...
        ShadowT.transform.localPosition = new Vector3(0.586f, 1.0f, 0.742f);//�e�������ʒu�ɖ߂�
    }
